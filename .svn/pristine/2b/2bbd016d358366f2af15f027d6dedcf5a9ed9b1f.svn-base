			...
			<div id="page-bgbtm">
				...
				<div id="content">
					<div class="post">
						...
						<form method="post" action="/attend/manage/attendance/date/search/search">
						...
						検索結果
						<hr/>
						<form method="get" action="/attend/manage/attendance/date/disp">
						...
						<table>
							<tr>
								<td><input type="submit" id="submit" name="update" value="選択" /></td>
