...
<body>
	...
	<div class="container">
		<div class="page-header">
			<h1>${f:h(currentYear)}年${f:h(currentMonth)}月の練習</h1>
		</div>
		
		<ul class="pager">
			<li class="previous">
				<a href="/attend/sp/member/practice/monthly?date=${f:h(beforeDate)}">&larr; 前月へ</a>
			</li>
			<li class="next">
				<a href="/attend/sp/member/practice/monthly?date=${f:h(nextDate)}">翌月へ &rarr;</a>
			</li>
		</ul>
		<div class="row">
			...
			<c:forEach var="e" items="${attendanceList}">
				...
				<form class="well"  method="post" action="/attend/sp/member/practice/monthly/update" >
